...
public class ColorMap {
    ...
    /**
     * Adds element to the map or updates its value if the key already exists.
     *
    ...
    /**
     * Determines whether the map contains a given pixel.
     *
    ...
    /**
     * Gets an array of the pixels in the map sorted by frequency.
     *
